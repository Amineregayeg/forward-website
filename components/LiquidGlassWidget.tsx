...
const socialLinks = [
  ...
  },
  {
    name: 'WhatsApp',
    icon: WhatsAppIcon,
    href: 'https://wa.me/33XXXXXXXXX', // TODO: Add real WhatsApp number
  },
  {
    name: 'Email',
    icon: Mail,
    href: 'mailto:contact@forward.com', // TODO: Add real email
  },
];
    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        <LiquidGlassCard
          ...
          glowIntensity="sm"
          borderRadius="50px"
          className="bg-slate-900/80 cursor-pointer"
        >
          <motion.div
            className="relative z-30 flex items-center overflow-hidden"
            animate={{
